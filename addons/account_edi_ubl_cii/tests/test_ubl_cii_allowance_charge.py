...
class TestUblCiiAllowanceCharge(TestUblCiiBECommon):
    ...
    def test_ubl_fixed_charge(self):
        ...
        self._assert_invoice_ubl_file(invoice, 'ubl/test_ubl_fixed_charge')
    ...
    def test_ubl_line_discount_allowance(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'ubl/test_ubl_line_discount_allowance')
    ...
    def test_ubl_variable_allowance_charge(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'ubl/test_ubl_variable_allowance_charge')
    ...
    def test_ubl_allowance_charge_mixed(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'ubl/test_ubl_allowance_charge_mixed')
    ...
    def test_ubl_allowance_charge_correct_import_amount_tax(self):
        ...
        file_path = "allowance_charge_xmls/ubl/test_ubl_allowance_charge_correct_import_amount_tax.xml"
        file_path = f"{self.test_module}/tests/test_files/{file_path}"
        xml_attachment = self.env['ir.attachment'].create({
            'mimetype': 'application/xml',
            'name': 'test_ubl_allowance_charge_correct_import_amount_tax.xml',
            'raw': self.file_read(file_path),
        })
        imported_invoice = self._import_as_attachment_on(
    ...
    def test_cii_fixed_charge(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'cii/test_cii_fixed_charge')
    ...
    def test_cii_variable_allowance_charge(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'cii/test_cii_variable_allowance_charge')
    ...
    def test_cii_allowance_charge_mixed(self):
        ...
        self._generate_invoice_ubl_file(invoice)
        self._assert_invoice_ubl_file(invoice, 'cii/test_cii_allowance_charge_mixed')
