...
class HrAttendance(models.Model):
            ...
            for day_data in attendance_dates:
                ...
                if not unfinished_shifts and attendances:
                    ...
                    # The employee usually work on that day
                        ...
                        if emp.is_flexible:
                            planned_work_duration -= self._get_leave_duration_outside_flexible_working_hours(leave_intervals, tz)
    ...
    def _get_leave_duration_outside_flexible_working_hours(self, leave_intervals, tz):
        outside_leave_duration = 0
        for interval in leave_intervals:
            ...
            if leave_date_from > end_time or leave_date_from < end_time < leave_date_to:
                ...
                outside_leave_duration += (reference_dt - end_time).total_seconds() / 3600.0
        return outside_leave_duration
