...
class Alert extends Component {
    static template = xml`
        <div t-attf-class="alert pos-navbar-height fixed-top py-3 px-1 rounded-0 alert-{{this.props.type}} fade show d-flex align-items-center justify-content-center rounded-bottom {{this.ui.isSmall ? 'w-100': 'w-50 fs-5 m-auto'}}" role="alert">
