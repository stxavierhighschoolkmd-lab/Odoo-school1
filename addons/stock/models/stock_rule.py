...
class StockRule(models.Model):
    ...
    def _get_rule(self, product_id, location_id, values):
        ...
        route_with_no_warehouse = self.env['stock.route']._search_routes_with_no_warehouse([])
        routes = (values.get('route_ids') or self.env['stock.route']) | route_with_no_warehouse
