...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/material_symbols', type='http', auth='none', cors="*")
    def fontawesome(self, **kwargs):
        return Stream.from_path('web/static/src/libs/materialsymbols/MaterialSymbolsRounded_wgth-400_opsz-24.woff2').get_response()
