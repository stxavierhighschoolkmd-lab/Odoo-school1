...
export class ResizePlugin extends Plugin {
    ...
    handleResize(ev, direction, resizingParameter, target1, target2) {
        ...
        if (resizingParameter.targetResolver) {
            [item, neighbor] = resizingParameter.targetResolver(item, neighbor, position);
        }
        ...
        switch (position) {
            ...
            case "middle": {
                ...
                if (newNeighborSize >= minSize) {
                    ...
                    item.style[sizeProp] = Math.round(newSize) + "px";
                    neighbor.style[sizeProp] = Math.round(newNeighborSize) + "px";
                } else {
                    ...
                    if (newContainerWidth <= maxContainerWidth) {
                        ...
                        resizeContainer.style[sizeProp] = Math.round(newContainerWidth) + "px";
                    }
                }
                break;
            }
