...
export class CollaborationSelectionPlugin extends Plugin {
    ...
    static dependencies = ["domMutation", "collaborationOdoo", "position", "localOverlay"];
    ...
    drawPeerSelection({ selection, peerId }) {
        ...
        let anchorNode = this.dependencies.domMutation.getNodeById(selection.anchorNodeId);
        let focusNode = this.dependencies.domMutation.getNodeById(selection.focusNodeId);
