...
class TestUniqueConstraints(TransactionCase):
    ...
    def test_unique_field_with_dependency_reroll(self):
        ...
        # which triggers the NO_UNIQ_VALUE -> dependency re-roll path.
        blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_json': [
                {
                    ...
                    'count': 4,
                    'fields': {
                        'name': {'generator': 'textual.char', 'length': 15, 'null_frac': '0'},
                        'category': {'generator': 'choice.selection', 'null_frac': '0'},
                        'description': {
            ...
            'definition_json': [
                {
                    ...
                    'count': 5,
                    'fields': {
                        'name': {'generator': 'textual.char', 'null_frac': '0'},
                        'stock_quantity': {
