...
class TestRecurrentEvent(common.TransactionCase):
    ...
    def test_recurrent_meeting3(self):
        ...
        self.assertEqual(meetings_count, 15, 'Recurrent yearly meetings should be created and not exceed 15!')
        ...
        self.assertEqual(meetings_count, 5, 'Recurrent yearly meetings should be created and not exceed 5!')
