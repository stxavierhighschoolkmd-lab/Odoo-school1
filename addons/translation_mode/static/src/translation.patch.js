 ...
 *
 * @typedef {[context: string, source: string, translation?: string]} TranslationMedatata
 */
...
function contextualizeTranslation(context, translation) {
    ...
    // 'translated' is always 0 if it comes from here
 ...
 *
 * Encoding happens on the server side; @see {@link addons/translation_mode/tools/translate.py}
 */
const CT_MAP =
    "\u200B\u200C\u200D\u200E\u200F\u2060\u2061\u2062\u2063\u2064\uFE00\uFE01\uFE02\uFE03\uFE04\uFE05".split(
        ""
...
const TRANSLATION_MODE_ADDON_NAME = "translation_mode";
...
/**
 * @param {0 | 1} translated
 * @param {TranslationMedatata} metadata
 * @param {string} translation
 */
export function encodeTranslation(translated, metadata, translation) {
...
export function parseTranslatedText(text) {
    ...
    const cleanedText = text.replaceAll(
        ...
        (fullMatch, translated, encodedMetadata) => {
            ...
            translations.push({
                context,
                translated: translated === CT_MAP[1],
                source,
