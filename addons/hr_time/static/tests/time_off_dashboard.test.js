...
import { defineHrHolidaysModels } from "./hr_time_test_helpers";

describe.current.tags("desktop");

class HrTime extends models.Model {
    _views = {
        calendar: `
            <calendar js_class="time_off_calendar_dashboard"
                      string="Time Off Request"
                      form_view_id="%(hr_time.hr_time_view_form_dashboard_new_time_off)d"
                      event_open_popup="1"
...
defineModels([HrTime, HrWorkEntryType]);
...
onRpc("hr.time", "get_unusual_days", () => ({}));
onRpc("hr.time", "has_access", () => true);
