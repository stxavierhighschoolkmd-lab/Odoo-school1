    ...
    def _import_additional_fields(self, invoice, vals):
        ...
        for model_name, fields in missing_fields.items():
            ...
            error_msg = Markup().join([
                ...
                Markup("%s<br/>" % _("Maybe consider creating them via Studio, or check if they have the correct datatype.")),
                Markup("%s <a href='https://docs.peppol.eu/poacc/billing/3.0/syntax/ubl-invoice/tree/' target='_blank'>%s</a>") % (
