...
class TestPropertiesGenerators(TransactionCase):
    ...
    def test_property_definition_basic(self):
        PropertyDefinition = Generator.get('properties.definition')
    ...
    def test_property_definition_with_virtual_fields(self):
        PropertyDefinition = Generator.get('properties.definition')
        PropertyProp = Generator.get('properties.prop')
        ...
        color_prop = next(color_gen)
        priority_prop = next(priority_gen)
        ...
        definition = definition_gen.send(known_vals)
    ...
    def test_property_value_basic(self):
        ...
        PropertyValue = Generator.get('properties.value')
        ...
        values = generator.send(known_vals)
    ...
    def test_properties_integration_full_workflow(self):
        ...
        prop_values = value_gen.send({'project_id': project.id})
    ...
    def test_property_definition_get_kwargs(self):
        PropertyDefinition = Generator.get('properties.definition')
        ...
        kwargs = PropertyDefinition.get_kwargs(attrs)
    ...
    def test_property_prop_get_kwargs(self):
        PropertyProp = Generator.get('properties.prop')
        ...
        kwargs = PropertyProp.get_kwargs(attrs)
    ...
    def test_property_value_falsy_dependency_returns_empty(self):
        ...
        values = generator.send({'project_id': False})
