...
class PortalWebClientController(WebclientController):
    @mail_data_handler("/mail/chatter_fetch", target=MailDataTarget.ALL)
    def _mail_data_chatter_fetch(
        self, store: Store, thread_model, thread_id, fetch_params=None, **params
    ):
    ...
    @mail_data_handler("/portal/chatter_init", target=MailDataTarget.ALL)
    def _mail_data_portal_chatter_init(self, store: Store, thread_id, thread_model, access_params=None, **params):
