...
const GPSPicker = InputUserValueWidget.extend({
        ...
        this._gmapLoaded = await new Promise(resolve => {
            this.trigger_up('gmap_api_request', {
                ...
                onSuccess: async (key) => {
                    ...
                    this.places = await this.contentWindow.google.maps.importLibrary("places");
    ...
    async start() {
        ...
        this._autocompleteWithGPS = wUtils.mountAutocompleteComponent(PlacesAutoComplete, {
    ...
    async _nearbySearch(gps, notify = true) {
        ...
        try {
            const { places } = await this.places.Place.searchNearby({
