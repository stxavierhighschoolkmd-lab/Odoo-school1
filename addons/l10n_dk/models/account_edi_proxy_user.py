...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_nemhandel_company_details(self):
        ...
        return {
            ...
            'nemhandel_company_cvr': self.env['res.partner']._extract_vat_without_country_code(self.company_id.vat),
    ...
    def _nemhandel_register_as_receiver(self):
        ...
        company_vat = self.env['res.partner']._extract_vat_without_country_code(company.vat)
