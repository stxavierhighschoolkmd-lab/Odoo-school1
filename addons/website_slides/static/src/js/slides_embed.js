...
export class SlidesEmbed extends Interaction {
    ...
    static selectorHas = "#PDFViewerCanvas";
    dynamicContent = {
        _root: {
            "t-on-wheel": async (ev) => {
    ...
    onEmbedShareClick(ev) {
        ...
        this.services.dialog.add(SlideShareDialog, {
            ...
            emailSharing: shareData.emailSharing === "True",
            embedCode: shareData.embedCode || "",
            id: parseInt(shareData.id),
            isChannel: shareData.isChannel === "True",
            name: shareData.name,
            url: shareData.websiteShareUrl || shareData.url,
        });
    }
