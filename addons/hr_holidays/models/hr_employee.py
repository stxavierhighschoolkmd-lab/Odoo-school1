...
class HrEmployee(models.Model):
    ...
    def _compute_next_working_day_on_leave(self):
        ...
        for employee in self:
            ...
            if next_working_day and next_working_day.date() == next_leave_day.date():
                employee.next_working_day_on_leave = next_working_day
            else:
    ...
    def _compute_leave_status(self):
        ...
        for employee, holidays in employee_holidays.items():
            ...
            employee.leave_date_from = min(holidays.mapped('date_from'))
            employee.request_date_from_period = latest_holiday.request_date_from_period
