...
class AccountEdiXmlOIOUBL21(models.AbstractModel):
    ...
    def _retrieve_rebate_val(self, record, tree, xpath_dict, quantity):
        ...
        rebate = super()._retrieve_rebate_val(record, tree, xpath_dict, quantity)

        discount_amount, allowance_charge_vals, _ = self._retrieve_allowance_charge_vals(record, tree, xpath_dict, quantity)
        ...
        return rebate + (discount_amount + allowance_amount - charge_amount) / quantity
