...
export class InlineCodePlugin extends Plugin {
    ...
    resources = {
        ...
        /** Predicates */
        is_formattable_node_predicates: (node) => !closestElement(node, "code.o_inline_code"),
        is_powerbox_available_predicates: (node) => !closestElement(node, "code.o_inline_code"),
        toolbar_visibility_predicates: (node) => !closestElement(node, "code.o_inline_code"),
    };
