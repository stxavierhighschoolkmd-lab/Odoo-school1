...
Decoding happens on the client side; see: <addons/translation_mode/static/src/translation.patch.js>
"""
CT_MAP = tuple('\u200B\u200C\u200D\u200E\u200F\u2060\u2061\u2062\u2063\u2064\uFE00\uFE01\uFE02\uFE03\uFE04\uFE05')
...
def contextualize_entry(entry: str):
    ...
    translated_bit = CT_MAP[1 if translation else 0]

    entry['value'] = translated_bit + byte_count + encoded_metadata + final_translation
    return entry
