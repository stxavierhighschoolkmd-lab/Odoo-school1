...
class TestVirtualFieldsJSON(TransactionCase):
            ...
            'definition_json': [
                {
                    ...
                    'count': 3,
                    'fields': {
                        'name': {'generator': 'textual.char', 'length': 15, 'null_frac': 0.0},
                        'price': {'generator': 'scalar.float', 'start': 10.0, 'end': 100.0, 'null_frac': 0.0},
...
class TestVirtualFieldsXML(TransactionCase):
            ...
            'definition_xml': '''
                <data>
                    <model name="test_populate.product" count="5">
                        <field name="name" generator="textual.char" length="15" null_frac="0"/>
                        <field name="price" generator="scalar.float" start="50.0" end="150.0" null_frac="0"/>
...
class TestVirtualFieldDependencies(TransactionCase):
