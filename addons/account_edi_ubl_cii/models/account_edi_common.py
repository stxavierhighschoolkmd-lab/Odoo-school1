...
COCONTRACTANT_DEFAULT_NOTE = ('Reverse charge: In the absence of a written objection within one month of receipt of the invoice, '
...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _get_BE_cocontractant_note(self, invoice, customer):
        if customer.country_id and customer.country_id.code == 'BE' and invoice.country_code == 'BE':
            ...
            if co_contractant and customer.property_account_position_id == co_contractant:
                note = html2plaintext(customer.property_account_position_id.note)
                return note if note else COCONTRACTANT_DEFAULT_NOTE
        return ''
    ...
    def _get_tax_unece_codes(self, invoice, tax):
        ...
        cocontractant_note = self._get_BE_cocontractant_note(invoice, customer)
