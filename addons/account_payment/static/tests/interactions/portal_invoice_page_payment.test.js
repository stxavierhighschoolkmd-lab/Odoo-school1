            ...
            <div class="container mt-3">
                <div class="alert alert-info alert-dismissible fade show d-print-none css_editable_mode_hidden">
                    <div class="text-center">
                        ...
                        <a class="alert-link" href="/odoo/action-account.action_move_out_invoice_type/2"><i class="oi me-1" data-icon="east"></i>Back to edit mode</a>
                    </div>
            ...
            <div class="o_portal container mt-3">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <ol class="o_portal_submenu breadcrumb mb-0 flex-grow-1 px-0">
                        <li class="breadcrumb-item ms-1" data-oe-model="ir.ui.view" data-oe-id="539" data-oe-field="arch" data-oe-xpath="/t[1]/ol[1]/li[1]"><a href="/my/home" aria-label="Home" title="Home"><i class="oi" data-icon="home"></i></a></li>
                    ...
                    <div class="record_pager btn-group" role="group">
                        <a role="button" data-oe-model="ir.ui.view" data-oe-id="556" data-oe-field="arch" data-oe-xpath="/t[1]/t[1]/div[1]/a[1]" class="btn btn-light" href="/my/invoices/13?access_token=0bccb494-a155-43f2-9832-fe163a740edb"><i class="oi" data-icon="chevron_backward" role="img" aria-label="Previous" title="Previous"></i></a>
                        <a role="button" data-oe-model="ir.ui.view" data-oe-id="556" data-oe-field="arch" data-oe-xpath="/t[1]/t[1]/div[1]/a[2]" class="btn btn-light" href="/my/invoices/14?access_token=bd2e4e49-a208-4a8d-aec1-9b2286d437a8"><i class="oi" data-icon="chevron_forward" role="img" aria-label="Next" title="Next"></i></a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="o_portal_sidebar_content flex-grow-1 mb-4 mb-lg-0 pe-lg-4" id="sidebar_content">
                                    <div class="position-relative d-flex align-items-center justify-content-md-center justify-content-lg-between flex-wrap gap-2">
                                        ...
                                        <div class="small w-100 text-center">
                                            <i class="oi" data-icon="schedule" data-oe-model="ir.ui.view" data-oe-id="789" data-oe-field="arch" data-oe-xpath="/data/xpath/div/t[1]/t[2]/div[2]/i[1]"></i>
                                    ...
                                    <div class="d-flex flex-column gap-4 mt-3">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <i class="oi oi-fw oi-filled" data-icon="arrow_circle_right"></i> Pay Now
                                            </a>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="alert alert-warning mt-2">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <strong><i class="oi" data-icon="east"></i> Payment Providers</strong>
                                                                </a>
                                                            </div>
                                                        </div>
                        ...
                        <div class="modal-content mt-5">
                            <form method="get" class="o_searchbar_form s_searchbar_input" action="/website/search" data-snippet="s_searchbar_input">
                                <div role="search" class="input-group input-group-lg">
                                    ...
                                    <i class="oi" data-icon="search" data-oe-model="ir.ui.view" data-oe-id="1019" data-oe-field="arch" data-oe-xpath="/data/xpath[3]/form/t[1]/div[1]/button[1]/i[1]"></i>
                                    </button>
                                </div>
