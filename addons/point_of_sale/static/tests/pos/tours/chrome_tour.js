...
registry
    ...
    .add("test_bank_account_statements_creation_for_config_opening_statement", {
        steps: () =>
            [
                Chrome.startPoS(),
                ProductScreen.enterOpeningAmount("100.00"),
...
registry
    .category("web_tour.tours")
    .add("test_bank_account_statements_creation_for_config_cash_in_out_statements", {
        steps: () =>
            [
                Chrome.startPoS(),
                ProductScreen.addOrderline("Monitor Stand", "2", "10"),
...
registry
    .category("web_tour.tours")
    .add("test_bank_account_statements_creation_for_config_closing_session_statements", {
        steps: () =>
            [
                Chrome.startPoS(),
                ProductScreen.addOrderline("Monitor Stand", "2", "10"),
                ...
                ProductScreen.isShown(),
                Chrome.clickMenuOption("Close Register"),
                ProductScreen.closeWithCashAmount("150"),
