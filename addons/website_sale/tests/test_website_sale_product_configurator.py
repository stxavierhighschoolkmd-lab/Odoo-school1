...
class TestWebsiteSaleProductConfigurator(HttpCase, WebsiteSaleCommon):
    ...
    def test_multi_website_breadcrumb_category(self):
        ...
        self.product.product_tmpl_id.public_categ_ids = [Command.set([category_1.id, category_2.id])]

        for website, category in [(self.website, category_1), (website_2, category_2)]:
            with MockRequest(self.env, website=website):
                values = self.pc_controller._prepare_product_values(self.product.product_tmpl_id, category=None)
