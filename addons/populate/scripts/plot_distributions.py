...
DISTRIBUTIONS = [
    {
        'label': "Normal\n(mean=50, std=40)",
        'dist': NormalDistribution(mean=50, std=40, rng=RNG),
        'discrete': False,
    },
    {
        'label': "Uniform\n(min=10, max=90)",
        'dist': UniformDistribution(min=10, max=90, rng=RNG),
        'discrete': False,
    },
    {
        'label': "Exponential\n(rate=0.04)",
        'dist': ExponentialDistribution(rate=0.04, rng=RNG),
        'discrete': False,
    },
    {
        'label': "Beta\n(α=2, β=5)",
        'dist': BetaDistribution(alpha=2, beta=5, rng=RNG),
        'discrete': False,
    },
    {
        'label': "Triangular\n(min=10, max=90, mode=70)",
        'dist': TriangularDistribution(min=10, max=90, mode=70, rng=RNG),
        'discrete': False,
    },
    {
        'label': "Poisson\n(λ=45)",
        'dist': PoissonDistribution(lam=45, rng=RNG),
        'discrete': True,
    },
]
